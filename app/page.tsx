import Stats from "@/companents/about/Stats";
import HeroSection from "@/companents/Home/HeroSection";
import Image from "next/image";

export default function Home() {
  const news = [
    { id: 1, title: "Ғолибияти хонандагон дар олимпиада", date: "25.04.2026", img: "/news1.jpg" },
    { id: 2, title: "Ҷашни иди Наврӯз дар мактаб", date: "21.03.2026", img: "/news2.jpg" },
    { id: 3, title: "Маҷлиси падару модарон", date: "10.05.2026", img: "/news3.jpg" },
  ];
  return (
    <>
      <HeroSection />
      <Stats />
      <section className="pb-20 md:pt-50 pt-80 bg-gray-50">
            ...
            {news.map((item) => (
              <div key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 group cursor-pointer">
                <div className="relative h-56 w-full overflow-hidden">
                  {/* Дар ин ҷо Image-и Next.js-ро бо width/height истифода баред */}
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 mt-3 text-sm line-clamp-2">
                    Хонандагони мактаби мо дар олимпиадаи шаҳрӣ сазовори ҷойҳои намоён гаштанд...
                  </p>
                </div>
              </div>
            ))}

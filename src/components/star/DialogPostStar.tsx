...
function DialogPostStar({ children, open, onOpenChange, data }: TypeDialogPostStar) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className='md:min-w-xl  w-full'>
                <DialogHeader>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                    <div className='flex col-span-2 md:col-span-1 flex-col gap-1'>
                        <label className='font-semibold text-gray-500'>Ному Насаб</label>
                        <Input placeholder='Назаров Мухсиддин' className='border border-gray-300' type="text" />
                    </div>
                    <div className='flex col-span-2 md:col-span-1 flex-col gap-1'>
                    ...
                    <div className='col-span-2 flex flex-col gap-1'>
                        ...
                        <textarea placeholder='...' className="w-full min-h-10 mt-1 p-2 rounded-lg border border-slate-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-800 dark:text-white outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none transition-all" />
                    </div>
                </div>

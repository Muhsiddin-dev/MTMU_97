            ...
            <nav className='md:flex hidden max-w-7xl mx-auto justify-between items-center py-3 '>
                ...
                <Link href="/">
                    <div className='flex items-center gap-3 cursor-pointer'>
                        <div className='bg-green-700/80 w-12 h-12 rounded-xl flex items-center justify-center shadow-lg shadow-green-100'>
                            <Image
                                src="/mtmu_97.png"
                                alt="Logo"
                                width={50}
                ...
                <div className='flex gap-2 items-center'>
                    <button className='text-sm cursor-pointer font-semibold text-gray-700 hover:text-green-700/80 px-4 py-2 transition-all'>
                        Ворид Шудан
                    </button>

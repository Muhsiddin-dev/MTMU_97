...
function Location() {
    return (
        <div className='bg-gray-50  md:px-0 px-3 py-5 md:min-h-screen'>
            <div className='max-w-7xl flex flex-col gap-5 w-full m-auto'>
                <div>
                    <h2 className="text-3xl font-bold text-gray-900">Макони Мо</h2>
                    <div className={`h-1 w-20 bg-${Config.ColorProject} mt-2`}></div>
                </div>
                <div className='border bg-gray-100 rounded-2xl w-full md:h-[75vh] h-[50vh]'>

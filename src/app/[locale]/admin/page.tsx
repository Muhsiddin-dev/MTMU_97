    ...
    <div className=" bg-gray-50 dark:bg-neutral-950 ">
      <div className="">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button 
            onClick={handleSave}
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-blue-600/20 active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6 bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-slate-200 dark:border-neutral-800 shadow-sm">
            <div className="flex items-center gap-2 text-blue-600 font-bold mb-4 border-b pb-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full mt-1 p-3 rounded-xl border border-slate-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-800 dark:text-white outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-slate-200 dark:border-neutral-800 shadow-sm">
              ...
              <div className="relative group cursor-pointer overflow-hidden rounded-xl border-2 border-dashed border-slate-200 dark:border-neutral-700 h-48 flex items-center justify-center bg-gray-50 dark:bg-neutral-800 hover:border-blue-500 transition-all">

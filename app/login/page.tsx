            ...
            <div className="bg-white dark:bg-[#0f0f0f] border border-gray-100 dark:border-neutral-800 rounded-[2rem] shadow-2xl shadow-gray-200/50 dark:shadow-none p-8 md:p-11 max-w-md w-full transition-all">
                ...
                <div className="flex flex-col items-center mb-5">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2 text-center">
                        Барои ворид шудан маълумотро пур кунед
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-end">
                        <button className="text-sm font-bold text-green-600 hover:text-green-700 dark:text-green-500 transition-colors cursor-pointer">
                            Рамзро фаромӯш кардам?
                        </button>
                    </div>
                </div>
